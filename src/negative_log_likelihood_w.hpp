// Modified version of mlpacks's negative_log_likelihood to add class weights

/**
 * @file methods/ann/loss_functions/negative_log_likelihood.hpp
 * @author Marcus Edel
 *
 * Definition of the NegativeLogLikelihoodWType class.
 *
 ...
 */
#ifndef MLPACK_METHODS_ANN_LAYER_NEGATIVE_LOG_LIKELIHOOD_W_HPP
#define MLPACK_METHODS_ANN_LAYER_NEGATIVE_LOG_LIKELIHOOD_W_HPP
...
class NegativeLogLikelihoodWType
{
 public:
  ...
  arma::Row<typename MatType::elem_type> ClassWeights() const { return classWeights; };
  //! Modify the class weights.
  arma::Row<typename MatType::elem_type>& ClassWeights() { return classWeights; };
 ...
 private:
  ...
  bool reduction;
  //! Boolean value that tells if weights were initalized.
  bool weighted;
...
using NegativeLogLikelihoodW = NegativeLogLikelihoodWType<arma::mat>;

} // namespace mlpack

// Include implementation.
#include "negative_log_likelihood_w_impl.hpp"
